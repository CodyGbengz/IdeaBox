module.exports = {
  'Users can see home page': (client) => {
    client
      ...
      .assert.visible('div.overlay')
      .assert.visible('h3')
      .assert.containsText('h3', 'IdeaBox')
      .assert.visible('p')
      .assert.containsText('p', 'Your center for innovative thinking, idea generation and management')
      .assert.visible('a.btn-large.green')
      .assert.containsText('a.btn-large.green', 'GET STARTED')
      .assert.visible('a.modal-trigger.green')
      .assert.containsText('a.modal-trigger.green', 'LOGIN')
      .click('#signup-btn')
      .assert.urlEquals('http://localhost:5000/signup')
      .assert.visible('h4')
      .assert.containsText('h4', 'IdeaBox')
      .assert.visible('i.fa.fa-home')
      .assert.containsText('h5', 'Signup')
      .assert.visible('p')
      .assert.containsText('p', 'Your center for innovative thinking, idea generation and management')
      .assert.visible('input#username')
      .assert.visible('input#email')
      .waitForElementVisible('input[name="username"]', 10000)
      .setValue('input[name="username"]', 'helloma')
      .pause(3000)
      .setValue('input[name=email]', 'dee@baba1.com')
      .pause(3000)
      .setValue('input[name=password]', 'gdfadsrdsfgfad')
      .pause(6000)
      .assert.visible('button#signup')
      .click('#signup')
      .assert.urlEquals('http://localhost:5000/dashboard')
      .assert.visible('body', 3000)
      .assert.visible('h3.head')
      .assert.containsText('h3.head', 'IdeaBox')
...
// 'button.btn.waves-teal.waves-effect',
//       'BORROW'
// );
...
//       .assert.containsText(
// 'btn.waves-teal.waves-effect.custom',
//         'VIEW FULL PROFILE'
// )
